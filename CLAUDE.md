...
claimed, added to when an element connects and released when it disconnects -- is a
...
3. **One path writes it and one path releases it**, both in the storage scope each element
   owns, and nothing else reads it.
